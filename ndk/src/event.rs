...
pub enum SourceClass {
    None = ffi::AINPUT_SOURCE_CLASS_NONE as i32,
    Button = ffi::AINPUT_SOURCE_CLASS_BUTTON as i32,
    Pointer = ffi::AINPUT_SOURCE_CLASS_POINTER as i32,
    Navigation = ffi::AINPUT_SOURCE_CLASS_NAVIGATION as i32,
    Position = ffi::AINPUT_SOURCE_CLASS_POSITION as i32,
    Joystick = ffi::AINPUT_SOURCE_CLASS_JOYSTICK as i32,
